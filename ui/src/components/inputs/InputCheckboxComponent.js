...
class InputCheckboxComponent extends Component {
    ...
    renderNew() {
        ...
        const required =
            validators !== undefined && validators.includes('required') && !validators.includes('not_required');
        return publicMode ? (
            <div className='input_easy_label row pl-0'>
                {label !== undefined && showLabel ? (
                ...
                <div className='col-md-5'>
                    <Checkbox
                        ...
                        name={name}
                        onChange={(e) =>
                            onChange ? onChange(InputType.CHECKBOX, undefined, e, onAfterStateChange, stateField) : null
                        }
                        checked={value}
                        disabled={disabled}
                        required={required}
                ...
                <div className={insideTable ? '' : 'row'}>
                    <div className={insideTable ? '' : 'col-md-12 form-group'}>
                        ...
                        <Checkbox
                            ...
                            onChange={(e) =>
                                onChange
                                    ? onChange(InputType.CHECKBOX, undefined, e, onAfterStateChange, stateField)
                                    : null
                            }
                            checked={value}
                            disabled={disabled}

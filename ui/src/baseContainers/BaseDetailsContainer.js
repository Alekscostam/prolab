...
class BaseDetailsContainer extends BaseContainer {
	...
	renderBackLink() {
		return <ActionLink rendered={this.backLinkRendered} label={this.getBackLabel()} className='p-link float-right' handleClick={this.handleGoBack.bind(this)} variant='blue' iconName='mdi-arrow-left' iconSide='left' iconSize='xs' iconColor='blue' />;
	}
